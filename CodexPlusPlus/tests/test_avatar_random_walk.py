...
def test_avatar_random_walk_moves_avatar_target_inside_primary_work_area(monkeypatch):
    ...
    monkeypatch.setattr(launcher.random, "uniform", lambda start, end: end)
    ...
    assert launcher.move_avatar_window_once(19339, {}) is True
    assert calls[-1] == (
        "Browser.setWindowBounds",
        {"windowId": 7, "bounds": {"left": 126, "top": 111, "width": 356, "height": 320}},
    )
